...
def plot_bulls_eye(data):
    ...
    def fill_gradient(ax,theta_start, theta_end, r_inner, r_outer, color_start, color_end):
        ...
        for i in range(100):  # Increase the number of interpolation steps for smoother transition
    ...
    plt.savefig('/data/stu1/liuanqi/vision/_Blood flow.png')
    plt.show()
...
plt.tight_layout()
plt.show()
plt.savefig('/data/stu1/liuanqi/heart_3C/heart_myunet/time/time_4.png')
